...
const BurnTracker: React.FC<{ className?: string }> = ({ className = "" }) => {
  return (
    <a 
      ...
      className={`group inline-flex items-center bg-chuck-primary border-2 border-chuck-secondary h-10 shadow-[4px_4px_0px_rgba(110,152,218,0.3)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_rgba(110,152,218,0.3)] hover:border-white transition-all cursor-pointer overflow-hidden max-w-[320px] md:max-w-[360px] ${className}`}
    >
